-- Drop and recreate the RMA number generation function with new format
...
BEGIN
  ...
  -- Format: RMA + YearHex + MonthlySeq(3 digits) + TotalSeq(last 3 digits)
  NEW.rma_number := 'RMA' || year_hex || LPAD(monthly_count::TEXT, 3, '0') || LPAD((total_count % 1000)::TEXT, 3, '0');
